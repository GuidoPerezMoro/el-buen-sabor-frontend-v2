    ...
    <main className="min-h-screen bg-gradient-to-b from-muted/60 to-background flex justify-center p-4 sm:p-6">
      <section className="w-full max-w-3xl rounded-2xl border border-border/60 bg-background/80 shadow-lg backdrop-blur-md p-4 sm:p-6 md:p-8 space-y-4">
        <header className="space-y-1">
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-text">Mi perfil</h1>
        ...
        {/* Perfil existente */}
        {!isLoading && user && state === 'ready' && cliente && (
          <div className="mt-4 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted">
                Si necesitas actualizar tus domicilios, por ahora deberás contactar al administrador
                del sistema. Próximamente agregaremos edición desde aquí.
              </p>
            </div>
          </div>
        )}
